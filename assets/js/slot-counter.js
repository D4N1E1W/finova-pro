...
function updateSlotCount() {
    ...
    document.querySelectorAll('.slot-count').forEach(el => el.textContent = slotCount);
    document.querySelectorAll('.time-frame').forEach(el => el.textContent = daysLeft === 1 ? 'today' : `in the next ${daysLeft} days`);
